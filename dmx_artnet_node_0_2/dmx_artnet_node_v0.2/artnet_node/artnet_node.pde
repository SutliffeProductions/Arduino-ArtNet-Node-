...
// for use Tinkerkit DMX shield uncomment this line, and read jumper modifications in deskontrol blog.
...
void setup() 
{
  ...
  ArtNode.numbports  = 0;
    ...
    // you need configure the jumpers in shield for UART mode
